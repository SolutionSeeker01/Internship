# Algorithmic Trading Platform & Execution Backend

High-throughput, multi-tenant algorithmic trading backend built for Indian equity & derivatives markets (Zerodha Kite Connect). Designed for zero-loss concurrency, deterministic crash recovery, automated trailing stop-loss ratcheting, and strict risk controls.
